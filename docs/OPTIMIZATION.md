...
ZSTD Algorithm - The selection of zstd rather than lz4 and lzo is purely based on reddit. While zstd is slower at compression than lz4 nad lzo its much faster at decompression.
